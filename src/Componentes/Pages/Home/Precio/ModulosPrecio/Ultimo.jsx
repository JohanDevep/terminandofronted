    ...
    <>
      <div className="flex-shrink-0 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/4 p-4">
        <div className="border border-gray-300 p-4 h-full bg-[#3e2158] text-white text-center font-sans">
          <h3 className="text-3xl font-medium py-3">ÚLTIMO</h3>
          <h2 className="text-4xl font-bold py-1">$1'200.000</h2>
          ...
          <button
            className="bg-gray-600 rounded-md text-white py-2 w-full mt-4 hover:bg-gray-700"
            onClick={handleShow}
          >
            EMPEZAR
          </button>
